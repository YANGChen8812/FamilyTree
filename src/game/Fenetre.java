...
public class Fenetre extends JFrame {
	...
	// Panel list
	String[] listContent = { "Menu", "Rules", "Tree", "Info", "Question",
			"Loose", "Win" };
	int indice = 0;
	...
	public Fenetre() {
		...
		rulesPanel
				.add(new JTextArea(
						"Le premier joueur choisis dans la liste la personne qu'elle souhaite faire deviner , elle peut lire les questions que l'adversaire pour l'aider dans son choix. \n"));
